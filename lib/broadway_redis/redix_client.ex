defmodule BroadwayRedis.RedixClient do
  @moduledoc """
  Default Redis client used by `BroadwayRedis.Producer` to communicate with Redis.

  This client implements the `BroadwayRedis.RedisClient` behaviour which
